...
In this part we are going to group our sequences into OTUS **But!**: Since our data set did not have a mock community, the fasta file created is actually empty. In this case I will run the dist.seqs command on my fasta file from step #**put what step here**, as follows:
