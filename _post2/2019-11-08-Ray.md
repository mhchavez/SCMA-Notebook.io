...
**Number** : How many contigs are found based on a k-mer. In the figure more 

**Total length**: How many bases have been assembled into the contigs. More = better.
Total length is super different for the assemblies at both the >=100nt assembly (11million TO 27 million) and the >=500nt (200K vs 5 million). Both the 100 and 500nt datasets are saying that the lower k-mer assemblies used (a lot) more data. This might not always be the case in a systematic comparison of methods. 
...
**Median**
The median length of the contigs in the assembly 
