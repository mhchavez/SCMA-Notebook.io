...
<img align="center" src="/IMAGES/nt4_1.jpg"> <strong>Figure. 1</strong>
...
In this part we are going to group our sequences into OTUS **But!**: Since our data set did not have a mock community, the fasta file created is actually empty. In this case I will run the dist.seqs command on my fasta file from step #**put what step here**, as shown in (b).

**1. dist.seq**

a) After removing the mock community
...
b) If our experiment did not hava a mock community
...
<table>
    <td>
        <tr><img align="center" src="/IMAGES/nt4_8.jpg" ></tr>
        <tr><img align="center" src="/IMAGES/nt4_9.jpg" ></tr>
    </td>
</table>
...
**check the files and put some screenshots here**
